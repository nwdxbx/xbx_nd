...
def shrink_poly(poly, r):
    ...
    '''
    # shrink ratio
    #R = 0.1     #if R = 0, then no shrink
    #R = 0.95   ##modified by hcl
    R = 1   ##modified by hcl
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                '''
                if np.random.rand() < background_ratio: #generate no text image and mask
                    # crop background
                ...
                else:   #resize image and anno to input size
