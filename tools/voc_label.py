...
xmls_dir = '/data_b/mount/bb4/train_8000_3/idcardfront/VOC2007/Annotations'
labels_dir = '/data_b/mount/bb4/train_8000_3/idcardfront/VOC2007/labels'
list_txt = '/data_b/mount/bb4/train_8000_3/idcardfront/VOC2007/ImageSets/Main/train.txt'
rootdir = '/data_b/mount/bb4/train_8000_3/idcardfront/VOC2007'
...
def generatetxt(trainratio=1.0,valratio=0.0,testratio=0.0):  
    ...
    for i in range(len(files)):  
        filename=files[i]  
        filename='/data3/xbx/train_8000_3/idcardfront/VOC2007' + "/JPEGImages/" +filename[:-3]+"jpg"+"\n"  
