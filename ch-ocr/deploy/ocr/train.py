...
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/Path&Text&Label2","r","utf-8")
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/words9_path","r","utf-8")  #256,10
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/road/symbol_num","r","utf-8") #128,8 
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/road/words3","r","utf-8") #128,5
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/road/road","r","utf-8")#
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/loss5","r","utf-8")
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/singlecharforctc","r","utf-8")#32
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/city_district/city_region_line","r","utf-8")#128,5
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/num/num_in_address","r")#128,6
#sd = codecs.open("/home/robot/hcl/generate_OCRimages/ShortWords/road/road","r","utf-8")#256,13
sd = codecs.open("/home/robot/hcl/generate_OCRimages/num/num16","r","utf-8")#256,13
...
imgpaths = []
imglabels = []
#imgpaths = [dd.split(",")[0].replace("words","words11") for dd in lines]
...
def train(path='../imageLine/data', img_w=150, epochs=10, initial_epoch=0, max_string_len=10, batch_size=256,weights_path=None):
    ...
    viz_cb = VizCallback(output_dir='/data/ocrmodel/keras_line_model/',
...
if __name__ == '__main__':
    d_root='/data/ocr/img/short_words2/'
    r_root='/data/ocrmodel/nice_keras_line_model/weights31.h5'
    train(d_root, img_w=256, epochs=901, initial_epoch=900, max_string_len=16, batch_size=128,weights_path=r_root)
    #train(d_root, img_w=256, epochs=901, initial_epoch=900, max_string_len=16, batch_size=128,weights_path=None)
